...
declare -A PACKS=(
  [arch-guardian]="master-planner ai-optimization fusion-sage higher-order-decision-architect stellar-roadmap verification-cockpit agent-orchestrator looper git-worktrees"
  ...
  [agentic-desktop]="master-planner finder-reactor tauri-agentic agent-orchestrator git-worktrees looper fusion-sage"
  [multi-agent]="master-planner agent-orchestrator looper git-worktrees concurrent-cli-agents split-to-prs"
