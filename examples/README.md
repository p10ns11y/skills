...
| [shellyxz-shell-kernel.md](overlays/shellyxz-shell-kernel.md) | [stellar-spacemap](../stellar-spacemap/SKILL.md) | Live scorecard + SN priorities for shell config dogfood |
